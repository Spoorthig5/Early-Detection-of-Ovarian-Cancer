...
def load_data():
    data1 = pd.read_csv("OC_Marker copy.csv")
    data2 = pd.read_csv("OC_Genarel_Chem copy.csv")
    data3 = pd.read_csv("OC_Blood_Routine copy.csv")
...
def run_models():
    ...
    # Ensure no data leakage by properly splitting the dataset
    ...
    # KNN
    print("\n--- Training KNN ---")
    knn_model = train_knn(X_train_resampled, X_test, y_train_resampled, y_test)

    # Random Forest
    print("\n--- Training Random Forest ---")
    rf_model = train_random_forest(X_train_resampled, X_test, y_train_resampled, y_test)

    # Decision Tree
    print("\n--- Training Decision Tree ---")
    dt_model = train_decision_tree(X_train_resampled, X_test, y_train_resampled, y_test)
